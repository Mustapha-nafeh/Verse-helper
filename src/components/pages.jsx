        ...
        {[...Array(6)].map((_, accordionIndex) => (
          ...
          >
            <div
              ...
              onClick={() => handleExpandAccordion(accordionIndex)}
            >
              Pages {accordionIndex * 100 + 1} - {(accordionIndex + 1) * 100}
            </div>
            {expandedAccordion === accordionIndex && (
              <div className="bg-white p-4 animate-fadeIn">
                {[...Array(100)].map((_, pageIndex) => {
                  const pageNumber = accordionIndex * 100 + pageIndex + 1;
                  ...
                  return (
                    <div
                      ...
                      onClick={() => handleExpandPage(pageNumber)}
                    >
